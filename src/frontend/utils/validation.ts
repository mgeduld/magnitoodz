...
export const getValidationErrors = (value: any, tests: IValidationTest[]) => {
    return tests.reduce((errorMessages: string[], validationTest: IValidationTest): string[] => {
...
export const runValidationTests = (tests: IValidtionTestsForValue[]) => {
    return tests.reduce((errorMessages: string[], testsForValue: IValidtionTestsForValue): string[] => {
