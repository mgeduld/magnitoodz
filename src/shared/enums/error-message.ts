...
export enum ErrorMessage {
  ...
  badSpan1Magnitude = 'Span 1 Magnitude must be a number between 1 and 200,000,000,000.',
  badSpan2Magnitude = 'Span 2 Magnitude must be a number between 1 and 200,000,000,000.',
